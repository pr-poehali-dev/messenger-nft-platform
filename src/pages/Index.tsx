...
const MOCK_NFTS: NFT[] = [
  { id: 1, name: 'Космический кот', image: '🚀', price: 0.5 },
  { id: 2, name: 'Единорог', image: '🦄', price: 0.3 },
  { id: 3, name: 'Огненный дракон', image: '🐉', price: 0.8 },
  { id: 4, name: 'Статуэтка monov', image: '🗿', price: 10.0, special: true },
  { id: 5, name: 'Звездная пыль', image: '✨', price: 0.2 },
  { id: 6, name: 'Радужная звезда', image: '🌟', price: 0.4 },
];
